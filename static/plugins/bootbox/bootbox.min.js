...
function a(b, c) {
    ...
    var o = {
        dialog: "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog modalAboutAlert'><div class='modal-content'><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
    ...
    r.confirm = function() {
        var a;
        if (a = k([ "confirm","cancel"], arguments, ["message", "callback"]), a.buttons.cancel.callback = a.onEscape = function() {
            return a.callback(!1)
        },
    ...
    r.dialog = function(a) {
        ...
        a.show && c.modal("show") && $('body').addClass('modal-open'),
        c
    },
