...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        dragIcon: '<i class="icon-menu-hamburger"></i>',
        dragClass: 'text-info',
    ...
    tFileIcon = '<i class="icon-file kv-caption-icon"></i>';
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="icon-triangle-left"></i>',
            next: '<i class="icon-triangle-right"></i>',
